(function () {
  ...
  if (!document.querySelector('link[href^="explorer-data.css"]')) { const style = document.createElement('link'); style.rel = 'stylesheet'; style.href = 'explorer-data.css?v=1.0.0'; document.head.appendChild(style); }
