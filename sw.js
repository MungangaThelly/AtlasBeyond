...
const SHELL = [
  ...
  './manifest.webmanifest', './install.js', './install.css', './assets/atlas-icon.svg', './assets/atlas-icon-192.png', './assets/atlas-icon-512.png', './assets/expeditions/iceland.jpg', './assets/expeditions/patagonia.jpg', './assets/expeditions/east-africa.jpg', './assets/expeditions/central-asia.jpg', './offline.html'
];
