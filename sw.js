...
const SHELL = [
  ...
  './favicon.ico', './manifest.webmanifest', './install.js', './install.css', './achievements.js', './achievements.css', './assets/atlas-icon.svg', './assets/atlas-icon-192.png', './assets/atlas-icon-512.png', './assets/expeditions/iceland.jpg', './assets/expeditions/patagonia.jpg', './assets/expeditions/east-africa.jpg', './assets/expeditions/central-asia.jpg', './offline.html', './offline.js', './offline.css'
];
