...
const required = {
  ...
  '/sw.js': ['atlas-beyond-v36', 'SKIP_WAITING', 'accessibility.js', 'accessibility.css', 'regional-field-notes.js', 'community-privacy.js', 'explorer-data.js', 'update-manager.js', 'map-fallback.js', 'offline.js', 'vendor/maplibre-gl/maplibre-gl.js'],
