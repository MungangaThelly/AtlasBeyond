...
const required = {
  ...
  '/region-player.html?expedition=patagonia-continents-end': ['id="region-map"', 'class="region-global-nav"', 'id="region-sound-toggle"', 'region-player.js?v=1.2.0', 'region-controls.js', 'east-africa-data.js', 'central-asia-data.js', 'resilience.js'],
  '/sw.js': ['atlas-beyond-v12'],
