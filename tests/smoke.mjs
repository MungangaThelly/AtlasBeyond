...
const required = {
  '/': ['id="onboarding"', 'app.js', 'iceland-expansion.js', 'canonical-content.js', 'canonical-adapter.js', 'resilience.js', 'manifest.webmanifest', 'install.js', 'achievements.js'],
